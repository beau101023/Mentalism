...
public class MentalismMessages
{
    ...
    public static void register()
    {
        ...
        net.messageBuilder(AddLingeringEffectS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(AddLingeringEffectS2CPacket::new)
                .encoder(AddLingeringEffectS2CPacket::toBytes)
                .consumer(AddLingeringEffectS2CPacket::handle)
                .add();

        net.messageBuilder(RemoveLingeringEffectS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(RemoveLingeringEffectS2CPacket::new)
                .encoder(RemoveLingeringEffectS2CPacket::toBytes)
                .consumer(RemoveLingeringEffectS2CPacket::handle)
                .add();
